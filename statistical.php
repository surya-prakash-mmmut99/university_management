<?php session_start(); ?>
  ...
  <tr>
    <td style="width:20%;">
      <p style="align:center;text-align:center;"><img src="images/ps.jpg" style="height:50px;width:50px;" alt=""></p>
      <br><br>
    </td>
    <td style="width:800px;font-size:12px;line-height:1mm;text-align:center" >
    <p><b>MADAN MOHAN MALVIYA UNIVERSITY  MANAGEMANT SYSTEM</b></p>
    <p>Silay City</p>

...
<head>
    ...
    <title>MADAN MOHAN MALVIYA UNIVERSITY  MANAGEMANT SYSTEM</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color:orange;">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp;<img src="ps.jpg" alt="....." width="5%">-*-*-MADAN MOHAN MALVIYA UNIVERSITY  MANAGEMANT SYSTEM-*-*-</b></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav" style="background-color:powderblue;">
                <li class="dropdown">
...
$page = $_GET['page'];
$pages = array('home', 'Students', 'subjects','student_p','addrecord','report','users','database','candidates', 'logs');
if (!empty($page)) {
    if(in_array($page,$pages)) {
        ...
        echo 'Sorry  Details will be uploaded soon as soon possible.................................... 
        Return
